...
def _create_braking_simulation_tab(self, parent):
    ...
    self._bk_ax_road.set_xlabel('Distance [m]', fontsize=10, color='#CCC')
    self._bk_ax_road.set_title('Braking Road View', fontsize=12,
                                fontweight='bold', color='#EEE')
    self._bk_ax_road.tick_params(labelsize=10, colors='#AAA')

    # Speed vs Distance
    self._bk_ax_speed = self._bk_road_fig.add_subplot(gs_road[1, 0])
    self._bk_ax_speed.set_title('Speed vs Distance', fontsize=12, fontweight='bold')
    self._bk_ax_speed.set_xlabel('Distance [m]', fontsize=10)
    self._bk_ax_speed.set_ylabel('Speed [km/h]', fontsize=10)
    self._bk_ax_speed.tick_params(labelsize=10)
    self._bk_ax_speed.grid(True, alpha=0.3)

    # Deceleration vs Distance
    self._bk_ax_decel = self._bk_road_fig.add_subplot(gs_road[2, 0])
    self._bk_ax_decel.set_title('Deceleration vs Distance', fontsize=12, fontweight='bold')
    self._bk_ax_decel.set_xlabel('Distance [m]', fontsize=10)
    self._bk_ax_decel.set_ylabel('Decel [g]', fontsize=10)
    self._bk_ax_decel.tick_params(labelsize=10)
    ...
    self._bk_abs_ax_sr.set_title('Slip Ratio & ABS', fontsize=12, fontweight='bold')
    self._bk_abs_ax_sr.set_ylabel('|SR| [%]', fontsize=10)
    self._bk_abs_ax_sr.tick_params(labelsize=10)
    self._bk_abs_ax_sr.grid(True, alpha=0.3)

    self._bk_abs_ax_bp = self._bk_abs_fig.add_subplot(gs_abs[1, 0])
    self._bk_abs_ax_bp.set_title('Brake Pressure', fontsize=12, fontweight='bold')
    self._bk_abs_ax_bp.set_xlabel('Time [s]', fontsize=10)
    self._bk_abs_ax_bp.set_ylabel('Brake', fontsize=10)
    self._bk_abs_ax_bp.tick_params(labelsize=10)
    self._bk_abs_ax_bp.set_yticks([0, 1])
    self._bk_abs_ax_bp.set_yticklabels(['OFF', 'ON'], fontsize=12)
    ...
    self._bk_ax_fx_sr.set_title('Fx vs Slip Ratio', fontsize=12, fontweight='bold')
    self._bk_ax_fx_sr.set_xlabel('SR [%]', fontsize=10)
    self._bk_ax_fx_sr.set_ylabel('Fx [N]', fontsize=10)
    self._bk_ax_fx_sr.grid(True, alpha=0.3)

    self._bk_ax_ke_dist = self._bk_fx_fig.add_subplot(gs_fx[1, 0])
    self._bk_ax_ke_dist.set_title('Kinetic Energy vs Distance', fontsize=12, fontweight='bold')
    self._bk_ax_ke_dist.set_xlabel('Distance [m]', fontsize=10)
    self._bk_ax_ke_dist.set_ylabel('Energy [kJ]', fontsize=10)
    self._bk_ax_ke_dist.grid(True, alpha=0.3)

    self._bk_ax_fx_dist = self._bk_fx_fig.add_subplot(gs_fx[2, 0])
    self._bk_ax_fx_dist.set_title('Fx vs Distance', fontsize=12, fontweight='bold')
    self._bk_ax_fx_dist.set_xlabel('Distance [m]', fontsize=10)
    self._bk_ax_fx_dist.set_ylabel('Fx [N]', fontsize=10)
...
def _draw_braking_road_static(self):
    ...
    ax.set_ylim(-1.5, 1.5)
    ax.set_yticks([])
    ax.set_title('Braking Road View', fontsize=12, fontweight='bold', color='#EEE')
    ax.tick_params(labelsize=10, colors='#AAA')
    ...
    ax.set_xlabel('Distance [m]', fontsize=10, color='#CCC')
    ...
    ax_s.set_title('Speed vs Distance', fontsize=12, fontweight='bold')
    ax_s.set_xlabel('Distance [m]', fontsize=10)
    ax_s.set_ylabel('Speed [km/h]', fontsize=10)
    ax_s.tick_params(labelsize=10); ax_s.grid(True, alpha=0.3)
    ax_d.set_title('Deceleration vs Distance', fontsize=12, fontweight='bold')
    ax_d.set_xlabel('Distance [m]', fontsize=10)
    ax_d.set_ylabel('Decel [g]', fontsize=10)
    ax_d.tick_params(labelsize=10); ax_d.grid(True, alpha=0.3)
...
def _init_braking_contour_artists(self):
    ...
    self._bk_ax_stick.legend(handles=legend_patches, loc='upper right', fontsize=10,
    ...
    self._bk_ax_press.text(0, _roll_y3 - W_mm * 0.08, '\u2190 Rolling Dir.',
             fontsize=12, ha='center', va='top', color='#00C853',
             fontweight='bold', zorder=7)
    self._bk_ax_press.text(-L_mm * 0.42, 0, 'LE', fontsize=12, ha='right', va='center',
             color='#333', fontweight='bold', fontstyle='italic', zorder=7)
    self._bk_ax_press.text(L_mm * 0.42, 0, 'TE', fontsize=12, ha='left', va='center',
             color='#333', fontweight='bold', fontstyle='italic', zorder=7)
    ...
    ax_sr.clear()
    ax_sr.set_title('Fx vs Slip Ratio', fontsize=12, fontweight='bold')
    ax_sr.set_xlabel('SR [%]', fontsize=10)
    ax_sr.set_ylabel('Fx [N]', fontsize=10)
    ...
    ax_ke.set_title('Kinetic Energy vs Distance', fontsize=12, fontweight='bold')
    ax_ke.set_xlabel('Distance [m]', fontsize=10)
    ax_ke.set_ylabel('Energy [kJ]', fontsize=10)
    ...
    ax_ke.text(d['dist'][-1] * 0.02, KE_initial / 1000 * 1.02,
               f'KE\u2080 = {KE_initial/1000:.1f} kJ', fontsize=12, color='#666')
    ax_ke.legend(fontsize=10, loc='center right')
    ...
    ax_fd.clear()
    ax_fd.set_title('Fx vs Distance', fontsize=12, fontweight='bold')
    ax_fd.set_xlabel('Distance [m]', fontsize=10)
    ax_fd.set_ylabel('Fx [N]', fontsize=10)
...
def _init_braking_pedal_gauge(self):
    ...
    ax.text(0, 1.1, 'BRAKE', fontsize=12, ha='center', va='top',
    ...
    self._bk_pedal_pct_label = ax.text(0, -1.3, '0%', fontsize=12,
                                        ha='center', va='top',
                                        fontweight='bold', color='#F44336', zorder=3)
    # SR display
    self._bk_pedal_sr_label = ax.text(0, -0.0, 'SR: 0%', fontsize=12,
                                       ha='center', va='center',
...
def _init_braking_abs_graph(self):
    ...
    ax_sr.set_title('Slip Ratio & ABS', fontsize=12, fontweight='bold')
    ax_sr.set_ylabel('|SR| [%]', fontsize=10)
    ax_sr.tick_params(labelsize=10)
    ax_sr.grid(True, alpha=0.3)

    ax_bp.set_title('Brake Pressure', fontsize=12, fontweight='bold')
    ax_bp.set_xlabel('Time [s]', fontsize=10)
    ax_bp.set_ylabel('Brake', fontsize=10)
    ax_bp.tick_params(labelsize=10)
    ax_bp.set_yticks([0, 1])
    ax_bp.set_yticklabels(['OFF', 'ON'], fontsize=12)
    ...
    if d is not None:
        ...
        ax_sr.legend(fontsize=10.5, loc='upper right')
