...
def _create_braking_simulation_tab(self, parent):
    ...
    self._bk_ax_road.set_xlabel('Distance [m]', fontsize=14, color='#CCC')
    self._bk_ax_road.set_title('Braking Road View', fontsize=14,
    ...
    self._bk_ax_speed.set_title('Speed vs Distance', fontsize=14, fontweight='bold')
    self._bk_ax_speed.set_xlabel('Distance [m]', fontsize=14)
    self._bk_ax_speed.set_ylabel('Speed [km/h]', fontsize=14)
    ...
    self._bk_ax_decel.set_title('Deceleration vs Distance', fontsize=14, fontweight='bold')
    self._bk_ax_decel.set_xlabel('Distance [m]', fontsize=14)
    self._bk_ax_decel.set_ylabel('Decel [g]', fontsize=14)
    ...
    self._bk_abs_ax_sr.set_title('Slip Ratio & ABS', fontsize=14, fontweight='bold')
    self._bk_abs_ax_sr.set_ylabel('|SR| [%]', fontsize=14)
    ...
    self._bk_abs_ax_bp.set_title('Brake Pressure', fontsize=14, fontweight='bold')
    self._bk_abs_ax_bp.set_xlabel('Time [s]', fontsize=14)
    self._bk_abs_ax_bp.set_ylabel('Brake', fontsize=14)
    self._bk_abs_ax_bp.tick_params(labelsize=14)
    self._bk_abs_ax_bp.set_yticks([0, 1])
    self._bk_abs_ax_bp.set_yticklabels(['OFF', 'ON'], fontsize=14)
    ...
    ttk.Label(pedal_tire_frame, textvariable=self._bk_hud_var,
              font=('Consolas', 14), foreground='#0369A1').pack(pady=1)
    ...
    self._bk_ax_fx_sr.set_title('Fx vs Slip Ratio', fontsize=14, fontweight='bold')
    self._bk_ax_fx_sr.set_xlabel('SR [%]', fontsize=14)
    self._bk_ax_fx_sr.set_ylabel('Fx [N]', fontsize=14)
    self._bk_ax_fx_sr.grid(True, alpha=0.3)

    self._bk_ax_ke_dist = self._bk_fx_fig.add_subplot(gs_fx[1, 0])
    self._bk_ax_ke_dist.set_title('Kinetic Energy vs Distance', fontsize=14, fontweight='bold')
    self._bk_ax_ke_dist.set_xlabel('Distance [m]', fontsize=14)
    self._bk_ax_ke_dist.set_ylabel('Energy [kJ]', fontsize=14)
    self._bk_ax_ke_dist.grid(True, alpha=0.3)

    self._bk_ax_fx_dist = self._bk_fx_fig.add_subplot(gs_fx[2, 0])
    self._bk_ax_fx_dist.set_title('Fx vs Distance', fontsize=14, fontweight='bold')
    self._bk_ax_fx_dist.set_xlabel('Distance [m]', fontsize=14)
    self._bk_ax_fx_dist.set_ylabel('Fx [N]', fontsize=14)
    ...
    self.bk_result_text = tk.Text(sec4, height=14, font=('Consolas', 14),
...
def _draw_braking_road_static(self):
    ...
    ax.set_ylim(-1.5, 1.5)
    ax.set_yticks([])
    ax.set_title('Braking Road View', fontsize=14, fontweight='bold', color='#EEE')
    ...
    ax.set_xlabel('Distance [m]', fontsize=14, color='#CCC')
    ...
    ax_s.set_title('Speed vs Distance', fontsize=14, fontweight='bold')
    ax_s.set_xlabel('Distance [m]', fontsize=14)
    ax_s.set_ylabel('Speed [km/h]', fontsize=14)
    ax_s.tick_params(labelsize=14); ax_s.grid(True, alpha=0.3)
    ax_d.set_title('Deceleration vs Distance', fontsize=14, fontweight='bold')
    ax_d.set_xlabel('Distance [m]', fontsize=14)
    ax_d.set_ylabel('Decel [g]', fontsize=14)
    ...
    if d is not None:
        ...
        ax_s.legend(fontsize=14, loc='upper right')
...
def _init_braking_contour_artists(self):
    ...
    def _setup_contour_ax(ax, title):
        ...
        ax.set_ylabel('width [mm]', fontsize=14)
    ...
    def _make_inset_cb(mappable, ax, key, label='', **extra_kw):
        ...
        cb.ax.tick_params(labelsize=14, length=2, pad=1)
        if label:
            cb.set_label(label, fontsize=14.5)
    ...
    self._bk_ax_stick.text(0, _roll_y - W_mm * 0.08, '\u2190 Rolling Dir.',
             fontsize=14, ha='center', va='top', color='#00C853',
    ...
    self._bk_ax_stick.legend(handles=legend_patches, loc='upper right', fontsize=14,
    ...
    self._bk_ax_press.text(0, _roll_y3 - W_mm * 0.08, '\u2190 Rolling Dir.',
             fontsize=14, ha='center', va='top', color='#00C853',
             fontweight='bold', zorder=7)
    self._bk_ax_press.text(-L_mm * 0.42, 0, 'LE', fontsize=14, ha='right', va='center',
             color='#333', fontweight='bold', fontstyle='italic', zorder=7)
    self._bk_ax_press.text(L_mm * 0.42, 0, 'TE', fontsize=14, ha='left', va='center',
             color='#333', fontweight='bold', fontstyle='italic', zorder=7)
    ...
    ax_sr.clear()
    ax_sr.set_title('Fx vs Slip Ratio', fontsize=14, fontweight='bold')
    ax_sr.set_xlabel('SR [%]', fontsize=14)
    ax_sr.set_ylabel('Fx [N]', fontsize=14)
    ax_sr.grid(True, alpha=0.3)
    ax_sr.plot(d['sr_pct'], d['Fx'], '-', color='#1565C0', lw=1.2, label='Fx')
    ax_sr.legend(fontsize=14)
    ...
    ax_ke.set_title('Kinetic Energy vs Distance', fontsize=14, fontweight='bold')
    ax_ke.set_xlabel('Distance [m]', fontsize=14)
    ax_ke.set_ylabel('Energy [kJ]', fontsize=14)
    ...
    ax_ke.text(d['dist'][-1] * 0.02, KE_initial / 1000 * 1.02,
               f'KE\u2080 = {KE_initial/1000:.1f} kJ', fontsize=14, color='#666')
    ax_ke.legend(fontsize=14, loc='center right')
    ...
    ax_fd.clear()
    ax_fd.set_title('Fx vs Distance', fontsize=14, fontweight='bold')
    ax_fd.set_xlabel('Distance [m]', fontsize=14)
    ax_fd.set_ylabel('Fx [N]', fontsize=14)
    ax_fd.grid(True, alpha=0.3)
    ax_fd.plot(d['dist'], d['Fx'], '-', color='#F44336', lw=1.2, label='Fx')
    ax_fd.legend(fontsize=14)
...
def _init_braking_pedal_gauge(self):
    ...
    ax.text(0, 1.1, 'BRAKE', fontsize=14, ha='center', va='top',
    ...
    self._bk_pedal_pct_label = ax.text(0, -1.3, '0%', fontsize=14,
                                        ha='center', va='top',
                                        fontweight='bold', color='#F44336', zorder=3)
    # SR display
    self._bk_pedal_sr_label = ax.text(0, -0.0, 'SR: 0%', fontsize=14,
                                       ha='center', va='center',
...
def _init_braking_abs_graph(self):
    ...
    ax_sr.set_title('Slip Ratio & ABS', fontsize=14, fontweight='bold')
    ax_sr.set_ylabel('|SR| [%]', fontsize=14)
    ax_sr.tick_params(labelsize=14)
    ax_sr.grid(True, alpha=0.3)

    ax_bp.set_title('Brake Pressure', fontsize=14, fontweight='bold')
    ax_bp.set_xlabel('Time [s]', fontsize=14)
    ax_bp.set_ylabel('Brake', fontsize=14)
    ax_bp.tick_params(labelsize=14)
    ax_bp.set_yticks([0, 1])
    ax_bp.set_yticklabels(['OFF', 'ON'], fontsize=14)
    ...
    if d is not None:
        ...
        ax_sr.legend(fontsize=14.5, loc='upper right')
